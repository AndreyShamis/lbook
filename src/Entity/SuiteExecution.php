 ...
 *     @Index(name="jon_name_index", columns={"jon_name"}),
 ...
 *     @Index(name="fulltext_custom", columns={"name", "product_version", "uuid", "platform", "chip", "summary", "jon_name", "build_tag"}, flags={"fulltext"}),
 *  }
 * )
 */
