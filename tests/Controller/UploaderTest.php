...
class UploaderTest extends LogBookApplicationTestCase
{
     ...
     */
    protected function validateExistingTestResponse(string $stringResponse, string $setupName=null, string $token, string $fileName, $cycleName=null): void
    {
...
//        }
     ...
     * @param string $fileName
     */
    protected function validateNotExistingTestResponse(string $stringResponse, string &$setupName=null, string $token, string $fileName): void
    {
        $this->assertNotRegExp('/Failed to generate cycle/', $stringResponse);
        $this->assertRegExp('/Token provided \['.$token.'\]/', $stringResponse);
