...
class LogBookSetup
{
     ...
     * @ORM\Column(name="test_keep_logs_days", type="smallint", options={"unsigned"=true, "default"="400"})
     */
    protected $testKeepLogsDays = 400;

    /**
     * @var integer
     * Value in days used for delete test Debug Logs from DB
     * @ORM\Column(name="test_keep_debug_logs_days", type="smallint", options={"unsigned"=true, "default"="150"})
     */
    protected $testKeepDebugLogsDays = 150;

    /**
     * @var integer
     * Value in days used for delete test Info Logs from DB
     * @ORM\Column(name="test_keep_info_logs_days", type="smallint", options={"unsigned"=true, "default"="300"})
     */
    protected $testKeepInfoLogsDays = 300;
