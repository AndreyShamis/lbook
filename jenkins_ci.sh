...
./vendor/bin/simple-phpunit --verbose --debug --colors=always --strict-coverage --strict-global-state  --enforce-time-limit --testdox-text artifacts/phpunit.txt --configuration /var/www/lbook/phpunit.xml.dist
